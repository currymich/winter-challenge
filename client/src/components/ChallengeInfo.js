  ...
  return (
    <div className="row">
      ...
      <div id="intro" className="info-tab col s12">
        ...
        <h5>
          Here you can track progress on your winter challenge goals, earn
      ...
      <div id="reading" className="info-tab col s12">
        ...
        <h5>
          We have some recommended options below with differing values, but you
          are free to choose one of your own as well
        </h5>
        ...
        <div className="row">
          ...
          <div id="100pt" className="books col s12">
            ...
            <div className="book">
              Fictional C.S. Lewis Book
              <br />
              <sub>C.S. Lewis</sub>
            </div>

            <div className="book">
              Any Chuck Colson Book
              <br />
      ...
      <div id="memory" className="info-tab col s12">
        <h5>
          You can also earn points by memorizing verses and context about each
        </h5>
        <h5>
          The list of verses to choose from is below. Check{" "}
          <a href="https://static1.squarespace.com/static/527175c2e4b0b910b690a015/t/5a3b294f71c10b359f54d2bb/1513826640323/2017_Winter-Challenge-Verses.pdf">
            here
          </a>{" "}
          for the context you need to memorize along with each verse.
        </h5>

        <div className="verses">
          <div className="verse">Genesis 15:1-6</div>

          <div className="verse">Psalm 23:1-6</div>

          <div className="verse">Isaiah 40:27-31</div>

          <div className="verse">Habakkuk 3:17-18</div>

          <div className="verse">John 15:5-8</div>

          <div className="verse">Romans 8:1-3</div>

          <div className="verse">1 Corinthians 9:24-27</div>

          <div className="verse">Philippians 4:4-7</div>

          <div className="verse">Hebrews 12:1-3</div>

          <div className="verse">1 John 1:5-9</div>
        </div>
      </div>
      <div id="bible" className="info-tab col s12">
        <h5>You can also earn points by reading chapters of the bible</h5>
        <h5>
          Each chapter is worth 2 points. If you finish a chapter you will get
          an additional point per chapter!
        </h5>
      </div>
